...
def plot(surface, contour, zeta_0, gamma, figs_dir, make_svg, make_pdf, show):
    ...
    # ax.fill(surface.real,surface.imag, color='yellow', alpha=1.0)  
    ...
    ax.set_xticks([ -3.0, -2.0, -1.0, 0.0, 1.0, 2.0, 3.0], [ "-3", "-2", "-1", "0", "1", "2", "3"])
    ax.set_yticks([ -3.0, -2.0, -1.0, 0.0, 1.0, 2.0, 3.0], [ "-3", "-2", "-1", "0", "1", "2", "3"])
