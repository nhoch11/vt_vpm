...
fig1.savefig(f"figures/compare_vpm_and_jouk_appellian/appellian_values_zeta0={zeta_0}_D={D}_surface_offset={surface_offset:.1e}.png", format='png')
...
fig2.savefig(f"figures/compare_vpm_and_jouk_appellian/appellian_offset_error_zeta0={zeta_0}_D={D}_surface_offset={surface_offset:.1e}.png", format='png')
...
fig3.savefig(f"figures/compare_vpm_and_jouk_appellian/appellian_vpm_error_zeta0={zeta_0}_D={D}_surface_offset={surface_offset:.1e}.png", format='png')
...
fig4.savefig(f"figures/compare_vpm_and_jouk_appellian/appellian_vpm_vs_offset_error_zeta0={zeta_0}_D={D}_surface_offset={surface_offset:.1e}.png", format='png')
...
with pd.ExcelWriter(f"output_files/compare_vpm_and_jouk_appellian/appelliean_values_and_error_zeta0={zeta_0}_D={D}_surface_offset={surface_offset:.1e}.xlsx", engine="openpyxl") as writer:
